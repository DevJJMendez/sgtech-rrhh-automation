<fieldset class="form-section">
    ...
    <div class="input-row">
        <div class="input-group input-small">
            ...
            <input type="file" name="documents[cedula_ampliada]">
        </div>
        <div class="input-group input-small">
            <label for="">Certificados de estudios realizados</label>
            <input type="file" name="documents[certificado_estudios]">
        </div>
        <div class="input-group input-small">
            <label for="">Dos últimas certificaciones laborales</label>
            <input type="file" name="documents[certificaciones_laborales]">
        </div>
        <div class="input-group input-small">
            <label for="">Certificación de afiliación a EPS</label>
            <input type="file" name="documents[certificación_eps]">
        </div>
        <div class="input-group input-small">
            <label for="">Certificación de afiliación a Fondo de Pensiones</label>
            <input type="file" name="documents[certificación_de_afiliación_a_fondo_de_pensiones]">
        </div>
        <div class="input-group input-small">
            <label for="">Certificación bancaria</label>
            <input type="file" name="documents[certificación_bancaria]">
        </div>
        <div class="input-group input-small">
            <label for="">Antecedentes policía, procuraduría y contraloría</label>
            <input type="file" name="documents[antecedentes_judiciales]">
        </div>
        <div class="input-group input-small">
            <label for="">Fotografía para la firma de correo</label>
            <input type="file" name="documents[foto_firma_correo]">
        </div>

        <fieldset class="form-section">
            <legend class="">DOCUMENTOS PARA AFILIACION DE BENEFICIARIOS</legend>
            <fieldset class="form-section">
                <legend>Hijos</legend>
                <div class="input-row">
                    <div class="input-group input-small">
                    ...
                    <div class="input-group input-small">
                        ...
                        <input type="file" name="documents[certificado_laboral_conyuge]">
                    </div>
                    <div class="input-group input-small">
                        <label for="">Copia de la cédula del cónyuge.</label>
                        <input type="file" name="documents[copia_de_la_cédula_del_cónyuge]">
                    </div>
                    <div class="input-group input-small">
                        <label for="">En caso de ser madre cabeza de familia, la
                            ...
                            condición.</label>
                        <input type="file" name="documents[declaración_extrajuicio]">
                    </div>
                </div>
            </fieldset>
            <fieldset class="form-section">
                ...
                <div class="input-row">
                    <div class="input-group input-small">
                        ...
                        <input type="file" name="documents[conyuge_fotocopia_de_cédula_de_ciudadanía]">
                    </div>
                    <div class="input-group input-small">
                        <label for="">Registro civil de matrimonio o declaración
                            extrajuicio de convivencia en unión libre</label>
                        <input type="file"
                            name="documents[registro_civil_de_matrimonio_o_declaración_extrajuicio_de_convivencia_en_unión_libre]">
                    </div>
                    <div class="input-group input-small">
                        <label for="">Certificado laboral de la empresa donde
                            labora.</label>
                        <input type="file" name="documents[conyuge_certificado_laboral]">
                    </div>
                </div>
            </fieldset>
            <fieldset class="form-section">
                ...
                <div class="input-row">
                    <div class="input-group input-small">
                        ...
                        <input type="file" name="documents[padres_fotocopia_de_la_cédula_de_ciudadanía]">
                    </div>
                    <div class="input-group input-small">
                        <label for="">Registro civil de nacimiento del trabajador</label>
                        <input type="file" name="documents[padres_registro_civil_de_nacimiento_del_trabajador]">
                    </div>
                    <div class="input-group input-small">
                        <label for="">Certificación del SISBEN o EPS que sea beneficiario
                            del trabajador</label>
                        <input type="file" name="documents[padres_certificación_del_SISBEN_o_EPS]">
                    </div>
                    <div class="input-group input-small">
                        <p>
